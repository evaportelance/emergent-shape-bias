...
def update_train_accuracies(epoch_stats, labels, lgt_glb_mlp, lgt_glb_lin, name_mlp, name_lin):
    '''
...
#            epoch_stats.update('train_acc_glb_lin', hit_glb_lin, n=1)
            epoch_stats.update(name_mlp, hit_glb_mlp, n=1)
            epoch_stats.update(name_lin, hit_glb_lin, n=1)
