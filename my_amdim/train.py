...
from clevr_datasets import build_dataset
...
parser.add_argument('--input_dir', type=str, default='/mnt/Projects/game_data/clevr_1_10000/',
                    help="Input directory for the dataset. Not needed For clevr 1.")
...
def main():
    ...
    train_loader, test_loader = \
        build_dataset(batch_size=args.batch_size,
    ...
    if args.cpt_load_path:
        ...
        model = Model(ndf=args.ndf, n_rkhs=args.n_rkhs,
                    tclip=args.tclip, n_depth=args.n_depth, encoder_size=args.encoder_size,
    ...
    task(model, args.learning_rate, train_loader,
